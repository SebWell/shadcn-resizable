# 🎨 Shadcn/UI Resizable for Weweb

Beautiful **Resizable component** from [shadcn/ui](https://ui.shadcn.com/) adapted for Weweb.

## 🚀 Import in Weweb

1. Copy this repository URL: `https://github.com/YOUR_USERNAME/shadcn-resizable`
2. In Weweb editor, open developer panel (F12)
3. Add as "custom element"
4. The Resizable component will appear in your elements!
...
├── src/
│   ├── Resizable.vue    # Vue.js component
│   ├── cn.js            # CSS utility
